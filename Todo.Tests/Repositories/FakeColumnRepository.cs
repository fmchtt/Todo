...
public class FakeColumnRepository : IColumnRepository
{
    ...
    public static Board testBoard = new("Teste 2", Guid.Parse("bf0caef8-6f82-4537-8ce6-9c077767860b")) { Id = Guid.Parse("5bc63d83-a6e4-4ad4-a9f5-9f253ac6101d"), Participants = new List<User>() { testUser }, Owner = testUser };
    public static Board otherBoard = new("Teste", OtherUser.Id) { Participants = new List<User>() { OtherUser } };
